...
export default function Profile() {
  ...
  return (
    <div className="">
      {/* banner image  */}
      <div className="  md:w-[1540px] w-[423px] h-[100rem] flex flex-col items-center overflow-x-hidden">
          ...
          <div className=" 
           px-10 md:w-[1240px] h-[1000px] flex md:flex-row gap-4 flex-col md:mt-12">
            <div className="profile-form-navbar 
             md:mt-24 md:ml-10 w-[410px] md:w-[30%] ml-[-35px] md:h-[600px]  ">
              <h2>Profile</h2>
              <div className="profile-form-navbar-options w-[410px] md:w-[95%] md:h-[500px] ">
                <button
            ...
            <div
              className="profile-form right-sider md:w-[70%] 
               w-[370px] h-[900px] md:m-[5rem] ml-[-25px]"
            ...
            <div
              className="profile-form right-sider profile-form right-sider md:w-[60%] 
               w-[380px] h-[700px] md:m-[5rem] ml-[-25px]"
